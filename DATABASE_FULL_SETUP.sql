...
-- ############################################################
-- TABLE 5: wilaya_pricing (Algeria shipping zones)
-- ############################################################
...
-- ############################################################
-- TABLE 11: homepage_content (Homepage multilingual)
-- ############################################################
...
('hero_video_url', ''),
('logo_url', ''),
('instagram_url', 'https://instagram.com/celis.dz'),
('whatsapp_phone', '+213555555555'),
('email_address', 'contact@celis.dz'),
...
-- ############################################################
-- DEFAULT DATA: Site Content - About Page (EN)
-- ############################################################
...
-- ############################################################
-- DEFAULT DATA: Site Content - About Page (AR)
-- ############################################################
insert into site_content (section, field, lang, value, sort_order) values
...
('about_story', 'paragraph2', 'ar', 'كل قطعة في مجموعتنا هي إشارة إلى أوائل الألفية — النسيج اللامع، الأشكال الجريئة، والعصرية. نختار ونصمم ونوصّل بهدف واحد: جعل أزياء Y2K متاحة للجزائر وما بعدها.', 3),
...
-- ############################################################
-- DEFAULT DATA: Site Content - About Page (FR)
-- ############################################################
insert into site_content (section, field, lang, value, sort_order) values
...
('about_story', 'paragraph1', 'fr', 'Celis clothing est née de l''intersection de la nostalgie et de la culture numérique. Nous sélectionnons des modes inspirées du Y2K qui font le pont entre les esthétiques rétro et le streetwear moderne — conçue pour la génération qui a grandi à l''ère du pixel.', 2),
...
-- ============================================================
-- DONE! All 15 tables created with:
-- ✓ Tables: products, product_images, product_variants, categories,
--   wilaya_pricing, orders, order_items, stock_movements,
--   site_settings, site_content, homepage_content, admin_users,
--   outfits, outfit_images, outfit_items
-- ✓ Views: orders_full, products_with_stock, outfits_with_items
-- ✓ Functions: update_updated_at, decrease_stock_on_order, restore_stock_on_cancel
-- ✓ Triggers: auto-update updated_at for all tables
-- ✓ RLS: Public read + Admin full access
-- ✓ Default data: 58 wilayas, site settings, homepage content (EN/AR/FR), about page (EN/AR/FR)
-- ============================================================
